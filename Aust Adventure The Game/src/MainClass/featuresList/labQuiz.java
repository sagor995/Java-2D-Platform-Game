...
public class labQuiz{
    public static float labScore = 0;
    JFrame frame;
    JPanel panel;
  ...
  int fileCounter=0;
    ...
    public labQuiz() throws FileNotFoundException{
       ...
       nextButton=new JButton();
        ...
        file = new File("resources\\labQuiz\\lab1.txt");
      ...
      ansField.setSelectedTextColor(Color.GREEN);
        ...
        submitButton.setIcon(new ImageIcon("resources\\images\\others\\submit1.png"));
         submitButton.addActionListener(new labQuiz.submitListener());
       ...
       nextButton.setIcon(new ImageIcon("resources\\images\\others\\next1.png"));
        nextButton.addActionListener(new labQuiz.nextListener());
        
        
        labQuizBanner.setIcon(new ImageIcon("resources\\images\\background\\labQuiz.png"));
        labQuizBanner.setBounds(250,0,800,159);
        ...
        labScoreShow.setText("Lab Score: "+labScore);
           ...
           if(answer!=null){
            ...
            if (wrong1==1) {
                ...
                if (correct1==1) {
                    ...
                    ansField.setText("Click on NEXT Button(a_a)");
                    nextReady=true;
                    wrong1=0;
                    correct1=0;
//                    status1.setIcon(new ImageIcon(empty));
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if (nextReady==true) {
                try {
                    ...
                    labQuiz2 labQuiz2 = new labQuiz2();
