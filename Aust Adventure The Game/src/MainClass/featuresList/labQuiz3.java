...
public class labQuiz3{
    ...
    JLabel labScoreShow;
    JLabel labQuiz3Banner=new JLabel();
    JTextField ansField;
  ...
  int fileCounter=0;
    ...
    public labQuiz3() throws FileNotFoundException{
       ...
       nextButton=new JButton();
        ...
        file = new File("resources\\labQuiz\\lab3.txt");
      ...
      ansField.setSelectedTextColor(Color.GREEN);
        ...
        submitButton.setIcon(new ImageIcon("resources\\images\\others\\submit1.png"));
         submitButton.addActionListener(new labQuiz3.submitListener());
       ...
       nextButton.setIcon(new ImageIcon("resources\\images\\others\\next1.png"));
        nextButton.addActionListener(new labQuiz3.nextListener());
        
        
        labQuiz3Banner.setIcon(new ImageIcon("resources\\images\\background\\labQuiz.png"));
        labQuiz3Banner.setBounds(250,0,800,159);
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if (nextReady==true) {
               try {
                   ...
                   labQuiz4 labQuiz4 = new labQuiz4();
                     frame.dispose();
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(labQuiz2.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    }
