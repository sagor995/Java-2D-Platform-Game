...
public class labQuiz2{
  ...
  int fileCounter=0;
    ...
    public labQuiz2() throws FileNotFoundException{
      ...
      ansField.setSelectedTextColor(Color.GREEN);
        ...
        submitButton.setIcon(new ImageIcon("resources\\images\\others\\submit1.png"));
         submitButton.addActionListener(new labQuiz2.submitListener());
       ...
       nextButton.setIcon(new ImageIcon("resources\\images\\others\\next1.png"));
        nextButton.addActionListener(new labQuiz2.nextListener());
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if (nextReady==true) {
               try {
                   ...
                   labQuiz3 labQuiz3 = new labQuiz3();
                   frame.dispose();
